...
const APPLE_DEVICES = [
  ...
  { match: '375x667@2', model: 'iPhone SE 2', osRange: [13, 14, 15, 16, 17, 18] },
  { match: '375x667@2', model: 'iPhone 8', osRange: [11, 12, 13, 14, 15, 16] },
  { match: '375x667@2', model: 'iPhone 7', osRange: [10, 11, 12, 13, 14, 15] },
  { match: '375x667@2', model: 'iPhone 6s', osRange: [9, 10, 11, 12, 13, 14, 15] },
  { match: '414x736@3', model: 'iPhone 8 Plus', osRange: [11, 12, 13, 14, 15, 16] },
  { match: '414x736@3', model: 'iPhone 7 Plus', osRange: [10, 11, 12, 13, 14, 15] },
  { match: '414x736@3', model: 'iPhone 6s Plus', osRange: [9, 10, 11, 12, 13, 14, 15] },
  { match: '375x812@3', model: 'iPhone 11 Pro', osRange: [13, 14, 15, 16, 17, 18] },
  { match: '375x812@3', model: 'iPhone XS', osRange: [12, 13, 14, 15, 16, 17] },
  { match: '375x812@3', model: 'iPhone X', osRange: [11, 12, 13, 14, 15, 16] },
  { match: '414x896@2', model: 'iPhone 11', osRange: [13, 14, 15, 16, 17, 18] },
  { match: '414x896@2', model: 'iPhone XR', osRange: [12, 13, 14, 15, 16, 17] },
  { match: '414x896@3', model: 'iPhone 11 Pro Max', osRange: [13, 14, 15, 16, 17, 18] },
  { match: '414x896@3', model: 'iPhone XS Max', osRange: [12, 13, 14, 15, 16, 17] },
  { match: '360x780@3', model: 'iPhone 13 mini', osRange: [15, 16, 17, 18] },
  { match: '360x780@3', model: 'iPhone 12 mini', osRange: [14, 15, 16, 17, 18] },
  { match: '390x844@3', model: 'iPhone 14', osRange: [16, 17, 18] },
  { match: '390x844@3', model: 'iPhone 13', osRange: [15, 16, 17, 18] },
  { match: '390x844@3', model: 'iPhone 12', osRange: [14, 15, 16, 17, 18] },
  { match: '428x926@3', model: 'iPhone 14 Plus', osRange: [16, 17, 18] },
  { match: '428x926@3', model: 'iPhone 13 Pro Max', osRange: [15, 16, 17, 18] },
  { match: '428x926@3', model: 'iPhone 12 Pro Max', osRange: [14, 15, 16, 17, 18] },
  { match: '393x852@3', model: 'iPhone 16', osRange: [18] },
  { match: '393x852@3', model: 'iPhone 15 Pro', osRange: [17, 18] },
  { match: '393x852@3', model: 'iPhone 15', osRange: [17, 18] },
  { match: '393x852@3', model: 'iPhone 14 Pro', osRange: [16, 17, 18] },
  { match: '430x932@3', model: 'iPhone 16 Plus', osRange: [18] },
  { match: '430x932@3', model: 'iPhone 15 Pro Max', osRange: [17, 18] },
  { match: '430x932@3', model: 'iPhone 15 Plus', osRange: [17, 18] },
  { match: '430x932@3', model: 'iPhone 14 Pro Max', osRange: [16, 17, 18] },
  ...
  { match: '820x1180@2', model: 'iPad 10', osRange: [16, 17, 18] },
  { match: '820x1180@2', model: 'iPad Air 5', osRange: [15, 16, 17, 18] },
  { match: '820x1180@2', model: 'iPad Air 4', osRange: [14, 15, 16, 17] },
...
const ANDROID_DEVICES = [
  ...
  { match: '360x780@3', model: 'Galaxy S24' },
  { match: '360x740@3', model: 'Galaxy A55' },
