...
const APPLE_DEVICES = [
  ...
  { match: '375x812@3', model: 'iPhone XS', osRange: [12] },
  { match: '375x812@3', model: 'iPhone X', osRange: [11] },
  { match: '414x896@2', model: 'iPhone 11', osRange: [13, 14, 15, 16, 17, 18] },
  { match: '414x896@2', model: 'iPhone XR', osRange: [12] },
  { match: '414x896@3', model: 'iPhone 11 Pro Max', osRange: [13, 14, 15, 16, 17, 18] },
  { match: '414x896@3', model: 'iPhone XS Max', osRange: [12] },
  ...
  { match: '402x874@3', model: 'iPhone 16 Pro' },
  { match: '440x956@3', model: 'iPhone 16 Pro Max' },
  { match: '744x1133@2', model: 'iPad Mini 6' },
  { match: '820x1180@2', model: 'iPad 10', osRange: [16, 17, 18] },
  { match: '820x1180@2', model: 'iPad Air 5', osRange: [15] },
  { match: '820x1180@2', model: 'iPad Air 4', osRange: [14] },
